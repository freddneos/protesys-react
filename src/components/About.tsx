  ...
  >
    ...
    <div className="card bg-base-100 shadow-xl relative overflow-hidden rounded-[30px] backdrop-blur-sm">
      ...
      <div className="card-body p-8">
        ...
        >
          {index % 2 === 0 ? (
            <UilClinicMedical size={32} color="currentColor" className="w-8 h-8 text-primary group-hover:text-secondary transition-colors duration-300" />
          ) : (
            <UilCog size={32} color="currentColor" className="w-8 h-8 text-primary group-hover:text-secondary transition-colors duration-300" />
          )}
        </motion.div>
